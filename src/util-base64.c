// Modified version of https://github.com/NLnetLabs/simdzone/blob/main/src/generic/base64.h
  ...
  if (st.eof) {
    *outlen = 0;
    ...
    if (slen && (st.eof == BASE64_AEOF)) {
      ...
      is_good = ((base64_table_dec_8bit[*s++] == 254) && (slen == 1)) ? 1 : 0;
    }
    return is_good;
  }

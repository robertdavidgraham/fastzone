...
size_t zone_atom_hexl_a(const char *data, size_t cursor, size_t max, wire_record_t *out);
size_t zone_atom_hexc_a(const char *data, size_t cursor, size_t max, wire_record_t *out);
size_t zone_atom_hexes_a(const char *data, size_t cursor, size_t max, wire_record_t *out, unsigned *depth);
size_t zone_atom_hexels_a(const char *data, size_t cursor, size_t max, wire_record_t *out, unsigned *depth);
size_t zone_atom_hexl_b(const char *data, size_t cursor, size_t max, wire_record_t *out);
size_t zone_atom_hexc_b(const char *data, size_t cursor, size_t max, wire_record_t *out);
size_t zone_atom_hexes_b(const char *data, size_t cursor, size_t max, wire_record_t *out, unsigned *depth);
size_t zone_atom_hexels_b(const char *data, size_t cursor, size_t max, wire_record_t *out, unsigned *depth);
